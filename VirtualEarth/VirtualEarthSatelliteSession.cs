...
namespace TiledMaps
{
    public class VirtualEarthSatelliteSession : HttpMapSession
    {
        protected override Uri GetUriForKey(Key key)
        {
            ...
            return new Uri(string.Format("http://a{0}.ortho.tiles.virtualearth.net/tiles/a{1}.png?g=1", server, tile));
        }
